...
class BrowserTab(Gtk.VBox):
    def __init__(self, *args, **kwargs):
        ...
        refresh_button.connect("clicked", self._refresh_url)
        ...
        url_box.pack_start(refresh_button, False, False, 0)
    ...
    def _load_url(self, widget):
        ...
        if url == "about:history":
            self.webview.open("/tmp/history.html")
        elif not "://" in url:
            url = "http://" + url
...
class Browser(Gtk.Window):
    ...
    # add option to open,close,reload and more with keys
